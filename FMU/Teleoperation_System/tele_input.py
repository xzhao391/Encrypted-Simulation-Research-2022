...
def test_create_fmu_container_me(resources_dir):
    ...
    configuration = Configuration(
        ...
        components=[
            ...
            Component(
                filename=resources_dir + '/controller_input.fmu',
                interfaceType='CoSimulation',
                name='controller'
            ),
            Component(
    ...
    result = simulate_fmu(filename, start_time=0, stop_time=4, output_interval=.005,start_values={'bit_length':128, 'rho':1, 'rho_':32, 'delta':0.01})
